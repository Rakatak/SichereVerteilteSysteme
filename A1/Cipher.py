...
threeLetterDictionary = ['THE', 'AND', 'FOR', 'ARE', 'BUT', 'NOT', 'YOU', 'ALL', 'ANY', 'CAN', 'HAD', 'HER', 'WAS', 'ONE', 'OUR', 'OUT', 'DAY', 'GET', 'HAS', 'HIM', 'HIS', 'HOW', 'MAN', 'NEW',
...
cleartext = open(currentDirectory+"\\cleartext.txt", 'r+');
secondcleartext = open(currentDirectory+"\\2ndcleartext.txt", 'r+');
